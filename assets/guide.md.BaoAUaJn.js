import{_ as a,c as n,o as p,ah as e}from"./chunks/framework.C2PqkmK9.js";const h=JSON.parse('{"title":"指南","description":"","frontmatter":{},"headers":[],"relativePath":"guide.md","filePath":"guide.md","lastUpdated":1754013810000}'),l={name:"guide.md"};function i(t,s,c,o,g,d){return p(),n("div",null,s[0]||(s[0]=[e(`<h1 id="指南" tabindex="-1">指南 <a class="header-anchor" href="#指南" aria-label="Permalink to “指南”">​</a></h1><h2 id="判断是否有权限" tabindex="-1">判断是否有权限 <a class="header-anchor" href="#判断是否有权限" aria-label="Permalink to “判断是否有权限”">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>has_access($str)</span></span></code></pre></div><p>同 <code>if_access($str)</code></p><p>判断是否有权限，user表id为1是超管，将会跳过权限检查。</p><p><code>$str</code>是url，如 <code>admin/site/index</code></p><p>当不希望判断权限时需在控制器加</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>&lt;/div&gt;</span></span></code></pre></div><p>对应 <code>v-model</code> 为 <code>form.image</code></p><h2 id="多文件上传组件-带数量限制" tabindex="-1">多文件上传组件（带数量限制） <a class="header-anchor" href="#多文件上传组件-带数量限制" aria-label="Permalink to “多文件上传组件（带数量限制）”">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>vue_upload_files($name = &#39;files&#39;, $top = &#39;form&#39;, $mime = &#39;&#39;, $max_files = 1)</span></span></code></pre></div>`,78)]))}const u=a(l,[["render",i]]);export{h as __pageData,u as default};
