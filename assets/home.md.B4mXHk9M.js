...
<span class="line"><span>cache_delete(&#39;key&#39;);</span></span></code></pre></div><h2 id="model" tabindex="-1">Model <a class="header-anchor" href="#model" aria-label="Permalink to “Model”">​</a></h2><p>数据库字段不要使用mysql关键字，否则会有问题。 注意： <code>GROUP</code> <code>ORDER</code> <code>DESC</code> <code>ASC</code> 需大写</p><p>控制器中使用模型</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>namespace app\\your_project_name\\controller;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>class SiteController extends \\core\\AdminController</span></span>
<span class="line"><span>{</span></span>
